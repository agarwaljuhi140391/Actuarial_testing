...
def wrapped_IC_BASE_PAYBL_PP(REN_T,IC_PERIOD_M,COMM_RATE_ADJ_PC,COMM_MODAL_FAC,PREM_INC_PP):
	arr_IC_BASE_PAYBL_PP=np.zeros(REN_T.shape,dtype=float64)
	for y in prange(REN_T.shape[0]):
		for t in range(REN_T.shape[1]):
			arr_IC_BASE_PAYBL_PP[y,t]=IC_BASE_PAYBL_PP(REN_T[y,t],IC_PERIOD_M[0,0],COMM_RATE_ADJ_PC[y,t],COMM_MODAL_FAC[y,t],PREM_INC_PP[y,t])
	return arr_IC_BASE_PAYBL_PP
